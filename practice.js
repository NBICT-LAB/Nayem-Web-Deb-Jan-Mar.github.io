...
let js = 'awesome';
console.log(js);
console.log(7-11+2+4-10);

let firstName='nazmus';
let LastName='sakib nayem';
console.log(firstName+' '+LastName + ' is an it insturctor and enterpreneur' + firstName+' founded nbict lab ');
...
/*const now=2021;
const nayem= now-1998;

const davidAge=now-1990;

console.log(nayem,davidAge);

console.log(nayem*2,nayem/10, 2**3);
...
let description= country+ ' '+ 'is' + ' ' + 'in' + continent + ',' + 'it' + ' ' + population +' '+ 'people' + ' '+ 'speak' + ' '+ language;
...
let DolphinThirdScore = Number(prompt(`Dolphin Third Score`));

let KoalaFirstScore = Number(prompt(`Koala First Score`));
let KoalaSecondScore = Number(prompt(`Koala Second Score`));
let KoalaThirdScore = Number(prompt(`Koala Third Score`));
